...
import type { Ministry, Event, Resource, NewsItem } from "@/lib/types";
...
async function getData() {
  const [ministries, events, resources, news] = await Promise.all([
...
export default async function HomePage() {
  const { ministries, events, resources, news } = await getData();
